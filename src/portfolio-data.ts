export const portfolioData = {
    ...
    skills: [
        ...
        },
        {
            category: "Backend",
            icon: "Database",
            items: ["Java", "JavaEE", "Python", "PostgreSQL", "MongoDB", "Spring Boot", "Node.js", "Express", "RESTful APIs", "Firebase Functions"]
        },
        {
            category: "DevOps",
            icon: "Cloud",
            items: ["AWS", "Elastic Beanstalk", "EC2", "S3", "RDS", "CloudWatch", "IAM", "VPC", "CI/CD", "Jenkins", "Docker", "Kubernetes", "Vite", "Firebase"]
        },
        {
            category: "Tools",
            icon: "Code2",
    ...
    projects: [
        ...
        {
            title: "Memory Map",
            description: "A public, real-time, and collaborative application designed to visualize shared memories and points of interest on an interactive map. Users can contribute geographical \"memories\" that are instantly synchronized across all active users using **Firebase Firestore**, providing a living, shared tapestry of locations.",
            image: "/memory-map.webp",
            technologies: ["React", "TypeScript", "Node.js", "Vite", "Tailwind CSS", "Firebase"],
            liveUrl: "https://memory-map-sr.web.app/",
            githubUrl: "https://github.com/Cjohnson187/memory-map"
        },
        {
